...
# ==========================================
# [P1 & P2] CLASE: FORWARD KINEMATICS
# ==========================================
class ForwardKinematics:
    ...
    def compute_T0_6(self, thetas_deg):
        ...
        # TABLA DH ACTUALIZADA CON OFFSETS
        dh_params = [
    ...
    def verify_fk_5_configs(self, mc=None):
        # Tus 5 configuraciones exactas
        configuraciones = [
            [0, 0, 0, 0, 0, 0],                               # Config 1: Home (Referencia)
            [111.0, -24.69, -96.41, 38.14, 5.27, -8.34],      # Config 2: Posición INICIO
            [11.07, -15.64, -18.63, 39.9, 0.7, -32.51],       # Config 3: Posición MEDIO (Waypoint)
            [-73.91, -16.69, -102.74, 39.72, 0.17, -33.66],   # Config 4: Posición FINAL
            [111.0, -24.69, -96.41, 38.14, 5.27, -8.34]       # Config 5: Retorno a INICIO
        ]
...
# ==========================================
# [P3] CLASE: INVERSE KINEMATICS
# ==========================================
class InverseKinematics:
    def __init__(self):
        # Actualizado con la nueva geometría
        self.A2 = 110.0
        self.A3 = 96.0
        self.D1 = 134.65
    ...
    def verify_ik_3_positions(self, mc=None):
        # Tus 3 targets exactos
        posiciones_target = [
            [-18.0, 214.6, 142.8], # Target 1: Inicio
            [134.9, -38.8, 394.4], # Target 2: Medio
            [-7.6, -206.1, 155.0]  # Target 3: Final
        ]
        ...
        for pos in posiciones_target:
            ...
            if mc:
                ...
                # Reseteamos al "Medio" elevado para evitar choques entre puntos
